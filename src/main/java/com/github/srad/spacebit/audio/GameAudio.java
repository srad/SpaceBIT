...
import com.github.srad.spacebit.audio.factory.AudioFactory;
...
public class GameAudio {
  ...
  public GameAudio(Game game, Node parentNode, SoundType soundType) {
    ...
    // JME supports positional only for mono, music is stereo
    audioNode.setPositional(getSoundType() != SoundType.MUSIC);
    if (getSoundType() != SoundType.MUSIC) {
