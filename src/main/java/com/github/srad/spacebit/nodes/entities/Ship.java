...
//		}
  ...
  private void addShip() {
    spatial = this.assetManager.loadModel("meshes/ship6/ship6.obj");
    material = new Material(this.assetManager, "Common/MatDefs/Light/Lighting.j3md");

    material.setTexture("DiffuseMap", this.assetManager.loadTexture("meshes/ship6/ship6.png"));
    material.setTexture("NormalMap", this.assetManager.loadTexture("meshes/ship6/ship6_normals.png"));
